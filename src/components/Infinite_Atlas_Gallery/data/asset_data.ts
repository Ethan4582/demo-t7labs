...
export const projects: Project[] = [
   ...
   },
   {
      ...
      year: 2024,
      Tags: ["COMMUNICATION", "SOCIAL", "ILLUSTRATION"],
   ...
   },
   {
      ...
      year: 2021,
      Tags: ["ILLUSTRATION", "MOTION", "EXPERIENCE"],
